...
rm -rf rootfs-4.9.88-7825/usr/share/applications/about.desktop
echo "[Desktop Entry]" > rootfs-4.9.88-7825/usr/share/applications/about.desktop
echo "Name=about" >> rootfs-4.9.88-7825/usr/share/applications/about.desktop
echo Exec=su -c \"chromium chrome-extension://dkmjbdkmmdlcmejgicpmocamhaahbmpe/about.html\" user >> rootfs-4.9.88-7825/usr/share/applications/about.desktop
echo "Icon=about.png" >> rootfs-4.9.88-7825/usr/share/applications/about.desktop
echo "Terminal=false" >> rootfs-4.9.88-7825/usr/share/applications/about.desktop
echo "Type=Application" >> rootfs-4.9.88-7825/usr/share/applications/about.desktop
echo "X-MB-SingleInstance=true" >> rootfs-4.9.88-7825/usr/share/applications/about.desktop
echo "StartupNotify=false" >> rootfs-4.9.88-7825/usr/share/applications/about.desktop
currentdate=$(date '+%Y%m%d')
echo "Comment="$currentdate >> rootfs-4.9.88-7825/usr/share/applications/about.desktop

#cp -rf apache2-rootfs/* rootfs/.
echo "cp -rf rootfs-4.9.88-7825/* rootfs/."
#cp -rf rootfs-4.9.88/* rootfs/.
cp -rf rootfs-4.9.88-7825/* rootfs/.
...
cp apache2-rootfs/etc/xdg/autostart/apache-start.desktop rootfs/etc/xdg/autostart/apache-start.desktop
cp apache2-rootfs/usr/bin/apache2.sh rootfs/usr/bin/apache2.sh
rm -rf rootfs/usr/share/apache2/htdocs
cp -rf htdocs rootfs/usr/share/apache2/.
