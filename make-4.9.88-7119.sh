...
rm -rf rootfs-4.9.88-7119/usr/share/applications/about.desktop
echo "[Desktop Entry]" > rootfs-4.9.88-7119/usr/share/applications/about.desktop
echo "Name=about" >> rootfs-4.9.88-7119/usr/share/applications/about.desktop
echo Exec=su -c \"chromium chrome-extension://dkmjbdkmmdlcmejgicpmocamhaahbmpe/about.html\" user >> rootfs-4.9.88-7119/usr/share/applications/about.desktop
echo "Icon=about.png" >> rootfs-4.9.88-7119/usr/share/applications/about.desktop
echo "Terminal=false" >> rootfs-4.9.88-7119/usr/share/applications/about.desktop
echo "Type=Application" >> rootfs-4.9.88-7119/usr/share/applications/about.desktop
echo "X-MB-SingleInstance=true" >> rootfs-4.9.88-7119/usr/share/applications/about.desktop
echo "StartupNotify=false" >> rootfs-4.9.88-7119/usr/share/applications/about.desktop
